...
class CustomLabels(object):
    ...
    legend: list[str]=field(default_factory=lambda:["signal_1", "signal_2"])#["signal_1", "signal_2"]
...
class EITCustomPlots(ABC):
    ...
    @abstractmethod
    def plot(self, fig:figure.Figure, ax:axes.Axes, data:Any, labels:CustomLabels=None, options:Any=None)-> Tuple[figure.Figure,axes.Axes]:
        """Plot"""
...
class EITUPlot(EITCustomPlots):
    ...
    def plot(self, fig:figure.Figure, ax:axes.Axes, data:EITMeas, labels:CustomLabels=None, options:Any=None)-> Tuple[figure.Figure,axes.Axes]:
        ...
        if labels is None or not isinstance(labels, CustomLabels):
            labels= CustomLabels("Voltages", ["ref", "frame"], ["Measurement #", "Voltages in [V]"])
...
class EITImage2DPlot(EITCustomPlots):
    ...
    def plot(self, fig:figure.Figure, ax:axes.Axes, image:EITImage, labels:CustomLabels=None, options:Any=None, show:list[bool]=[True] * 4, colorbar_range:list[int]=None)-> Tuple[figure.Figure,axes.Axes] :
        """[summary]
