...
class FwdModel():
    ...
    initialized:int= 2
    SOLVER:list=field(default_factory=lambda:['eidors_default'  'fwd_solve_1st_order'  'aa_fwd_solve'])
    JACOBIAN:list=field(default_factory=lambda:['eidors_default'  'jacobian_adjoint'  'aa_calc_jacobian'])
    SYS_MAT:list=field(default_factory=lambda:['eidors_default'  'system_mat_1st_order'  'aa_calc_system_mat'])
